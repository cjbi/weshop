...
public class WechatAuthController extends BaseController {
    ...
    @PostMapping("/login")
    public ResultWrapper<LoginAuthResultVO> loginByWeixin(@RequestBody @Validated LoginAuthParamVO loginAuthParamVO) throws WxErrorException {
        return ResultWrapper.success(wechatAuthService.login(loginAuthParamVO));
    }
